			...
			$.getJSON("${ctx}/op_scene_json_data_collect_0523.action?op_Scene.scene_id="+id,{
				...
				if(scenes.length>0){
					...
					$.each(scenes,function(i,scene){
						inner += "<tr>";
						inner += "<td width=\"40%\">"+scene.scene_name+"</td>";
						inner += "<td width=\"20%\">"+scene.time+"</td>";
						inner += "<td width=\"10%\">"+scene.DO10_O+"</td>";
						inner += "<td width=\"10%\">"+scene.DO10_O_MAX+"</td>";
						inner += "<td width=\"10%\">"+scene.DO10_O_MIN+"</td>";
						inner += "<td width=\"10%\">"+scene.DO10_T+"</td>";
