					...
					if(channels.length>0){
						...
						inner_hid = "&nbsp;";
	  					$.each(channels,function(i,channel){
	  						if(channel.chtype_no == "ST10-11" || channel.chtype_no == "DO10-O" || channel.chtype_no == "DL-C" || channel.chtype_no == "NULL-P"){
	  							inner_show += "<input name=\"channels\" type=\"checkbox\" value=\""+channel.ch_id+"\">"+channel.ch_no+channel.ch_name+"&nbsp;";
	  						}else{
	  							inner_hid += "<input name=\"channels\" type=\"checkbox\" value=\""+channel.ch_id+"\">"+channel.ch_no+channel.ch_name+"&nbsp;";
	  						}
	  					})
	  				}
					...
					if(types.length>0){
						inner = "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">";
	  					$.each(types,function(i,type){
	  						if(type.chtype_no == "ST10-11" || type.chtype_no == "DO10-O" || type.chtype_no == "DL-C" || type.chtype_no == "NULL-P"){
		  						inner += "<tr>";
  ...
  <body style="font-size:12px;width:100%;height:100%;overflow: auto;padding: 10px;">
  	...
  	<table width="1006" cellpadding="0" cellspacing="0">
  		<tr>
  			<td width="100">
  				输入采集通道<br/>
  				<input type="button" value="更多" onclick="showMore()">
  			</td>
