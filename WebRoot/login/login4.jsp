...
<html>
  ...
  <body scroll="no">
  <form action="login_val.action" method="post">
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="560" align="center" class="enter_bg1"><table width="702" border="0" cellspacing="0" cellpadding="0" class="center">
      <tr  >
        <td height="30" valign="top" class="pix01"><!--版权信息 & 透明flash动画   start -->
          ...
          <tr>
            ...
            <td width="173"  class="load_input_td"><input type="text" class="input_bg" name="userName" id="loginName" size="18" maxlength="18" /></td>
          ...
          <tr>
            ...
            <td  class="load_input_td"><input type="password" class="input_bg" name="password" id="loginPwd" size="18" maxlength="16" /></td>
          </tr>
        </table>
              </div>
...
<%
	...
	if(messageObj != null) {
		out.print("<script>alert('"+messageObj.toString()+"');</script>");
	}
%>
</body>
</html>
