...
<html>
  ...
  <body style="font-size:12px;width:100%;height:100%;overflow: auto;padding: 10px;">
				...
				<a href="javascript:window.location.href=window.location.href">添加控制设备类型信息</a> </br>
    <form action="Op_DevCtrlType_save.action?post=1" method="post" onsubmit="return isValidate()" enctype="multipart/form-data">
    	<table cellpadding="0" cellspacing="0" width="1020" class="senfe1">
    		...
    		<tr>
				<td>类型编号</td>
				<td><input type="text" name="op_DevCtrlType.decttype_no" id="decttype_no"/></td>
			</tr>
			<tr>
				<td>类型名称</td>
				<td><input type="text" name="op_DevCtrlType.decttype_displayName" id="decttype_displayName"/></td>
			</tr>
			<tr>
				<td>类型型号</td>
				<td><input type="text" name="op_DevCtrlType.decttype_typeNo" id="decttype_typeNo"/></td>
			</tr>
			<tr>
				<td>类型功率</td>
				<td><input type="text" name="op_DevCtrlType.decttype_power" id="decttype_power"/></td>
			</tr>
			<tr>
				<td>类型供电电压</td>
				<td><input type="text" name="op_DevCtrlType.decttype_voltage" id="decttype_voltage"/></td>
			</tr>
			<tr>
				<td>类型说明</td>
				<td><input type="text" name="op_DevCtrlType.decttype_decription" id="decttype_decription"/></td>
			</tr>
			<tr>
				<td>类型图片资源</td>
				<td>
					未知:<input type="file" name="imagefile" ><br/>
					&nbsp;&nbsp;&nbsp;开:<input type="file" name="imagefile" ><br/>
					&nbsp;&nbsp;&nbsp;停:<input type="file" name="imagefile" ><br/>
					&nbsp;&nbsp;&nbsp;关:<input type="file" name="imagefile" >
				</td>
			</tr>
			
			<tr>
				<td>类型按钮数量</td>
				<td><input type="text" name="op_DevCtrlType.decttype_btnNum" id="decttype_btnNum"/></td>
			</tr>
			<tr>
				<td>通道状态反馈数据</td>
				<td><input type="text" name="op_DevCtrlType.decttype_chlStsNum" id="decttype_chlStsNum"/></td>
			</tr>		
			<tr>
