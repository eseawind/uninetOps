...
<html>
  ...
  <body style="font-size:12px;width:100%;height:100%;overflow: auto;padding: 10px;">
			...
			<a href="#">添加供应商信息</a> <br>
    <form action="Op_Supplier_save.action?post=1" method="post">
	  	<table width="1020" border="0" cellpadding="0" cellspacing="0" class="senfe1">
			...
			<tr>
				<td>供应商名称</td>
				<td><input type="text" name="op_Supplier.sup_name" id="sup_name"/></td>
			</tr>
			<tr>
				<td>供应商类型</td>
				<td>
			...
			<tr>
				<td>供应商国家</td>
				<td><input type="text" name="op_Supplier.sup_country" id="sup_country"/></td>
			</tr>
			<tr>
				<td>供应商地址</td>
				<td><input type="text" name="op_Supplier.sup_address" id="sup_address"/></td>
			</tr>			
			<tr>	
				<td>供应商邮编</td>
				<td><input type="text" name="op_Supplier.sup_zip" id="sup_zip"/></td>
			</tr>
			<tr>	
				<td>供应商固定电话</td>
				<td><input type="text" name="op_Supplier.sup_phone" id="sup_phon"/>例：0451-1234567</td>
			</tr>
			<tr>	
				<td>供应商传真</td>
				<td><input type="text" name="op_Supplier.sup_fax" id="sup_fax"/></td>
			</tr>
			<tr>	
				<td>联系人姓名</td>
				<td><input type="text" name="op_Supplier.sup_contactName" id="sup_contactName"/></td>
			</tr>
			<tr>
				<td>联系人电话</td>
				<td><input type="text" name="op_Supplier.sup_contactPhone" id="sup_contactPhone"/>例：0451-1234567</td>
			</tr>
			<tr>	
				<td>联系人手机</td>
				<td><input type="text" name="op_Supplier.sup_contactMobile" id="sup_contactMobile"/></td>
			</tr>
			<tr>
				<td>联系人邮箱</td>
				<td><input type="text" name="op_Supplier.sup_contactEmail" id="sup_contactEmail"/></td>
			</tr>		
			<tr>
