...
<html>
  ...
  <body style="font-size:12px;width:100%;height:100%;overflow: auto;padding: 10px;">
			...
			<a href="#"/>添加控制设备信息</a> <br>
    <form action="Gm_DevCtrl_save.action" method="post" id="addForm" name="addForm">
	  	<table cellpadding="0" cellspacing="0" width="100%" class="senfe1">
    		...
    		<tr>
				...
				<td><input type="text" name="gm_DevCtrl.dect_no" id="code" class="required"/></td>
			</tr>
    		<tr>
				<td><font color="red">*</font>设备名称</td>
				<td><input type="text" name="gm_DevCtrl.dect_name" class="required"/></td>
			</tr>
			<tr>
				<td><font color="red">*</font>设备序列号</td>
				<td><input type="text" name="gm_DevCtrl.dect_serial" class="required"/></td>
			</tr>
			<tr>
				<td><font color="red">*</font>类型编号</td>
				<td>
					<select name="gm_DevCtrl.decttype_id.decttype_id" class="required">					
					<c:forEach items="${requestScope.devctrtype}" var="devctrtype">
						<option value="${devctrtype.decttype_id}">${devctrtype.decttype_displayName}(${devctrtype.decttype_no})</option>					
					</c:forEach>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<select id="devId" name="gm_DevCtrl.dev_id.dev_id" onchange="findSelect(this)" class="required">
			...
			<tr>
				<td>购买时间</td>
				<td><input type="text" name="gm_DevCtrl.dect_buyDate" onfocus="setday(this,this)" readonly="readonly"/></td>
			</tr>	
			<tr>
				<td>服务到期时间</td>
				<td><input type="text" name="gm_DevCtrl.dect_overDate" onfocus="setday(this,this)" readonly="readonly"/></td>
			</tr>
			<tr>
				<td>生效时间</td>
				<td><input type="text" name="gm_DevCtrl.dect_effectTime" onfocus="setday(this,this)" readonly="readonly"/></td>
			</tr>
			<tr>
				<td>场景名称</td>
				<td>
					<input type="text" disabled="disabled" id="sceneSel" readonly="readonly"> <a href="javascript:showMenu()">选择</a> 必填
					<input type="hidden" id="gm_DevCtrl.scene_id.scene_id" name="gm_DevCtrl.scene_id.scene_id" value=""/>
				</td>
			</tr>
			<tr>
				<td>是否对外提供服务</td>
			...
			<tr>
				<td>设备说明</td>
				<td><input type="text" name="gm_DevCtrl.dect_decsription"/></td>
			</tr>
			<tr>
				<td colspan="2">
					...
					<table cellpadding="0" cellspacing="0" width="100%" class="senfe1" id="btnTable">
						...
						<tr id="btnTableTr" align="center">
							<td><input type="text" name="devCtrlBtnForm.btnName"/></td>
							<td>
							<select name="devCtrlBtnForm.btnType">
								<option value="1" selected="selected">开</option>
								<option value="2">停</option>
								<option value="3">反向</option>
							</select>
							</td>
							<td><input type="text" name="devCtrlBtnForm.btnChl"/></td>
							<td>
								<select name="devCtrlBtnForm.btnCtrlType">
									<option value="1">正向脉冲</option>
									<option value="2">反向脉冲</option>
									<option value="3">高电平</option>
									<option value="3">低电平</option>
								</select>
							</td>
							<td><input type="text" name="devCtrlBtnForm.btnDelay"/></td>
							<td></td>
						</tr>
						<tr id="btnTableTr" align="center">
							<td><input type="text" name="devCtrlBtnForm.btnName"/></td>
							...
							<select name="devCtrlBtnForm.btnType">
								...
								<option value="2" selected="selected">停</option>
								<option value="3">反向</option>
							</select>
							</td>
							<td><input type="text" name="devCtrlBtnForm.btnChl"/></td>
