...
<html>
  ...
  <body style="font-size:12px;width:100%;height:100%;overflow: auto;padding: 10px;">
    ...
    <form action="${ctx }/op_chtypeoperate_save.action?page.pageNo=${page.pageNo}&page.pageSize=${page.pageSize}&hid_condition=${hid_condition}&hid_value=${hid_value}" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
			<table cellpadding="0" cellspacing="0" width="1020" class="senfe1">
				...
				<tr>
					...
					<td>列名称: </td>
					<td>
						<input id="op_ChtypeOperate.cho_rowname" name="op_ChtypeOperate.cho_rowname" style="width:180px;"> 必填
					</td>
				</tr>
				<tr>
					<td style="width:12px; border-right: 0px;">*</td>
					<td>排序号: </td>
					<td>
						<input id="op_ChtypeOperate.cho_sequence" name="op_ChtypeOperate.cho_sequence" style="width:180px;"/> 必填
					</td>
				</tr>
				<tr>
					<td style="width:12px; border-right: 0px;">*</td>
				...
				<tr>
					...
					<td>位置编号: </td>
					<td>
						<input id="op_ChtypeOperate.ch_seat_no" name="op_ChtypeOperate.ch_seat_no" style="width:180px;"/>
					</td>
				</tr>
				<tr>
					<td style="width:12px; border-right: 0px;">&nbsp;</td>
					<td>通道深度: </td>
					<td>
						<input id="op_ChtypeOperate.ch_depth" name="op_ChtypeOperate.ch_depth" style="width:180px;"/>
					</td>
				</tr>
				<tr>
					<td style="width:12px; border-right: 0px;">&nbsp;</td>
