...
function dTree(objName, iPath, formId) {
	...
	this.icon = {
		root				: iPath+'/images/dtree/base.gif',		folder			: iPath+'/images/dtree/folder.gif',		folderOpen	: iPath+'/images/dtree/folderopen.gif',		node				: iPath+'/images/dtree/page.gif',		empty				: iPath+'/images/dtree/empty.gif',		line				: iPath+'/images/dtree/line.gif',		join				: iPath+'/images/dtree/join.gif',		joinBottom	: iPath+'/images/dtree/joinbottom.gif',		plus				: iPath+'/images/dtree/plus.gif',		plusBottom	: iPath+'/images/dtree/plusbottom.gif',		minus				: iPath+'/images/dtree/minus.gif',		minusBottom	: iPath+'/images/dtree/minusbottom.gif',		nlPlus			: iPath+'/images/dtree/nolines_plus.gif',		nlMinus			: iPath+'/images/dtree/nolines_minus.gif'
	};
	this.parEnum = "";
	this.obj = objName;
	this.aNodes = [];
