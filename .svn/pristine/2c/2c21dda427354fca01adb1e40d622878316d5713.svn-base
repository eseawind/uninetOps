...
<html>
  ...
  <body style="font-size:12px;width:100%;height:100%;overflow: auto;padding: 10px;">
  	...
  	<a href="#">添加网络信息</a> </br>
    <form action="${ctx }/gm_devnet_save_0716.action?page.pageNo=${page.pageNo }&page.pageSize=${page.pageSize}&scene_id=${scene_id}&hid_condition=${hid_condition }&hid_value=${hid_value }" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">       		
			<input name="gm_DevNet.net_state" type="hidden" value="1">
			<input id="gm_DevNet.net_pid" name="gm_DevNet.net_pid" type="hidden" value="FF">
			<table cellpadding="0" cellspacing="0" width="1020" class="senfe1">
				...
				<!-- tr>
					...
					<td>网络编号：</td>
					<td>
						<input id="gm_DevNet.net_no" name="gm_DevNet.net_no"/>
					</td>
				</tr -->
				<tr>
					<td style="width:12px; border-right: 0px;">*</td>
					<td>网络地址：</td>
					<td>
						<input id="gm_DevNet.net_addr" name="gm_DevNet.net_addr"/>
					</td>
				</tr>
				<tr>
					<td style="width:12px; border-right: 0px;">*</td>
				...
				<tr>
					...
					<td>网络深度：</td>
					<td>
						<input id="gm_DevNet.net_depth" name="gm_DevNet.net_depth"/> M2M设备为0,以此类推为0,1,2...整型
					</td>
				</tr>	
				<tr>
					<td style="width:12px; border-right: 0px;">*</td>
				...
				<tr>
					...
					<td>SIM卡号：</td>
					<td>
						<input id="gm_DevNet.net_sim" name="gm_DevNet.net_sim"/> <br/>
					</td>
				</tr>	
				<tr>
					<td style="width:12px; border-right: 0px;">&nbsp;</td>
					<td>应用类型：</td>
					<td>
						<input id="gm_DevNet.net_appType" name="gm_DevNet.net_appType"/>
					</td>
				</tr>
				<tr>
					<td style="width:12px; border-right: 0px;">&nbsp;</td>
					<td>短信中心号：</td>
					<td>
						<input id="gm_DevNet.net_smsc" name="gm_DevNet.net_smsc"/>
					</td>
				</tr>
				<tr>
					<td style="width:12px; border-right: 0px;">&nbsp;</td>
					<td>协议类型：</td>
					<td>
						<input id="gm_DevNet.net_pltType" name="gm_DevNet.net_pltType"/>
					</td>
				</tr>
				<tr>
